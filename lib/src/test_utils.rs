...
pub mod test_data {
    ...
    pub fn vd_test_pattern_pyramid() -> VertexData {
        ...
        let triangle_index = vec![
            ...
            [1, 2, 4],
            [2, 3, 4],
            [3, 0, 4], // 4 triangles sharing the center vertex
        ];
    ...
    pub fn vd_test_pattern_north() -> VertexData {
        ...
        let height = vec![32767, 32767, 0, 32767, 32767]; // Heights

        let triangle_index = vec![[0, 1, 2], [2, 3, 4], [4, 0, 2]];
